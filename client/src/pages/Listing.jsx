      ...
      {listing && !loading && !error && (
        <div>
          ...
          <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-6">
            ...
            <p className="flex items-center mt-3 gap-3 text-slate-600 text-sm my-2">
              <FaMapMarkerAlt className="text-red-700" /> {listing.address}
            </p>
            ...
            <ul className=" text-green-800 flex flex-wrap items-center gap-4 sm:gap-6">
